...
void updateDataFileAccess(SdFile *dataFile)
{
  if (online.dataLogging == true)
  {
    if (myGNSS.getTimeValid() == true && myGNSS.getDateValid() == true)
    {
      ...
      dataFile->timestamp(T_ACCESS, myGNSS.getYear(), myGNSS.getMonth(), myGNSS.getDay(), myGNSS.getHour(), myGNSS.getMinute(), myGNSS.getSecond());
      //Update the file write time
      dataFile->timestamp(T_WRITE, myGNSS.getYear(), myGNSS.getMonth(), myGNSS.getDay(), myGNSS.getHour(), myGNSS.getMinute(), myGNSS.getSecond());
    }
  }
}
...
void updateDataFileCreate(SdFile *dataFile)
{
  if (online.dataLogging == true)
  {
    if (myGNSS.getTimeValid() == true && myGNSS.getDateValid() == true)
    {
      ...
      dataFile->timestamp(T_CREATE, myGNSS.getYear(), myGNSS.getMonth(), myGNSS.getDay(), myGNSS.getHour(), myGNSS.getMinute(), myGNSS.getSecond());
    }
  }
}
