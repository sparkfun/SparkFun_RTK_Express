  ...
  while (1)
  {
    ...
    else if (incoming == '2')
    {
      if (getNMEASettings(UBX_NMEA_GGA, COM_PORT_UART1) == 1)
      {
        ...
        if (myGNSS.disableNMEAMessage(UBX_NMEA_GGA, COM_PORT_UART1) == true)
          settings.outputSentenceGGA = false;
      }
      else
      {
        //Enable the sentence
        if (myGNSS.enableNMEAMessage(UBX_NMEA_GGA, COM_PORT_UART1) == true)
    ...
    else if (incoming == '3')
    {
      ...
      {
        //Disable the sentence
        if (myGNSS.disableNMEAMessage(UBX_NMEA_GSA, COM_PORT_UART1) == true)
          settings.outputSentenceGSA = false;
      }
      else
      {
        //Enable the sentence
        if (myGNSS.enableNMEAMessage(UBX_NMEA_GSA, COM_PORT_UART1) == true)
    ...
    else if (incoming == '4')
    {
      ...
      {
        //Disable the sentence
        if (myGNSS.disableNMEAMessage(UBX_NMEA_GSV, COM_PORT_UART1) == true)
      ...
      else
      {
        ...
        if (myGNSS.enableNMEAMessage(UBX_NMEA_GSV, COM_PORT_UART1, settings.gnssMeasurementFrequency) == true)
    ...
    else if (incoming == '5')
    {
      ...
      {
        //Disable the sentence
        if (myGNSS.disableNMEAMessage(UBX_NMEA_RMC, COM_PORT_UART1) == true)
          settings.outputSentenceRMC = false;
      }
      else
      {
        //Enable the sentence
        if (myGNSS.enableNMEAMessage(UBX_NMEA_RMC, COM_PORT_UART1) == true)
    ...
    else if (incoming == '6')
    {
      ...
      {
        //Disable the sentence
        if (myGNSS.disableNMEAMessage(UBX_NMEA_GST, COM_PORT_UART1) == true)
          settings.outputSentenceGST = false;
      }
      else
      {
        //Enable the sentence
        if (myGNSS.enableNMEAMessage(UBX_NMEA_GST, COM_PORT_UART1) == true)
    ...
    else if (incoming == '7')
    {
      ...
      {
        //Disable
        if (myGNSS.disableMessage(UBX_CLASS_RXM, UBX_RXM_RAWX, COM_PORT_UART1) == true)
          settings.gnssRAWOutput = false;
      }
      else
      {
        //Enable
        if (myGNSS.enableMessage(UBX_CLASS_RXM, UBX_RXM_RAWX, COM_PORT_UART1) == true)
