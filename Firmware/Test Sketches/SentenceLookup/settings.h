...
struct ubxMsgs
{
  ...
  //struct ubxMsg rxm_pmreq = {UBX_RXM_PMREQ, UBX_CLASS_RXM, 0, "UBX_RXM_PMREQ"};
...
struct struct_settings {
  ...
  int rtkIdentifier = 2; // rtkIdentifier **must** be the second entry
  ...
  bool fixedBaseCoordinateType = 1;
